...
public class MeshExtrusion
{
	...
	public static void ExtrudeMesh (Mesh srcMesh, Mesh extrudedMesh, Matrix4x4[] extrusion, bool invertFaces, bool buildCaps)
	{
		Edge[] edges = BuildManifoldEdges(srcMesh);
		ExtrudeMesh(srcMesh, extrudedMesh, extrusion, edges, invertFaces, buildCaps);
	}	
	
	public static void ExtrudeMesh (Mesh srcMesh, Mesh extrudedMesh, Matrix4x4[] extrusion, Edge[] edges, bool invertFaces, bool buildCaps)
	{
